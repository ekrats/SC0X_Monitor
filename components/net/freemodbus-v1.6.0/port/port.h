...
#define SLAVE_RS485_RECEIVE_MODE    GPIO_SetBits(GPIOB,GPIO_Pin_12)
#define SLAVE_RS485_SEND_MODE       GPIO_ResetBits(GPIOB,GPIO_Pin_12)

#define MASTER_RS485_RECEIVE_MODE  	GPIO_SetBits(GPIOB,GPIO_Pin_12)
#define MASTER_RS485_SEND_MODE      GPIO_ResetBits(GPIOB,GPIO_Pin_12)
