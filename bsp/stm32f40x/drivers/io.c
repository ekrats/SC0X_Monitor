...
#define IO_PORT6 (GPIOG)
#define IN_PORT6_PIN (GPIO_Pin_12 | GPIO_Pin_13 | GPIO_Pin_14 | GPIO_Pin_15)
 
#define OUT_PORT7_PIN (GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_6 | GPIO_Pin_7)
#define IO_PORT7 (GPIOA)
...
void io_gpio_config()
{
    ...
    GPIO_InitStructure.GPIO_Pin = IN_PORT6_PIN;
    GPIO_Init(IO_PORT6, &GPIO_InitStructure);
    ...
    GPIO_InitStructure.GPIO_Pin = OUT_PORT7_PIN;
    GPIO_Init(IO_PORT7, &GPIO_InitStructure);
	                /////////////////////fan
